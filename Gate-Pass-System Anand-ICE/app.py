...
# Page configuration
st.set_page_config(
    page_title='Gate Pass System for Anand-ICE',
    page_icon='🙋‍♂️',
)
...
def main():
    st.title("Face Recognition based Gate Pass System for Anand-ICE Main Gate")
    ...
    if choice == "Image Detection":
        ...
        st.write("This Application is Developed By Anmol and Chetan")
